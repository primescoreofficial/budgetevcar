...
export default function RunningCostComingSoon() {
      ...
      <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-6">
          <div className="flex items-center gap-2 text-xs font-medium text-slate-400">
            ...
            <span>/</span>
            <span className="text-slate-700 font-bold">EV Running Cost Calculator</span>
          </div>
        </div>
        ...
        <main className="max-w-xl mx-auto px-4 sm:px-6 pt-16 pb-20 text-center">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 leading-tight mb-3">EV Running Cost Calculator</h1>
          ...
          <p className="text-slate-500 text-sm font-medium leading-relaxed mb-8">
            Compare dynamic electricity rates with petrol and diesel price metrics to understand ex-showroom running cost figures for different EV brands.
          </p>
