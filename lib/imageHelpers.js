...
/**
 * Resolves the vehicle thumbnail URL (preferred 600x400).
 */
export function getVehicleThumbnail(car) {
  if (!car) return '';
  if (car.vehicle_thumbnail && !car.vehicle_thumbnail.includes('images.unsplash.com/photo-1593941707882-a5bba14938c7')) {
    return getImageUrl(car.vehicle_thumbnail);
  }
  if (car.vehicle_image && !car.vehicle_image.includes('images.unsplash.com/photo-1593941707882-a5bba14938c7')) {
    return getImageUrl(car.vehicle_image);
  }
